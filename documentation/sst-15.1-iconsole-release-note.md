...
- Introduced debug watchpoints which allow defining conditional expressions of mapped variables which result in user defined actions such as entering interactive mode or generating a checkpoints
